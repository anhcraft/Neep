...
<br><br>
Ý tưởng của Neep ra đời bắt nguồn từ Yaml - là một loại format lưu trữ dữ liệu dưới dạng có thể đọc được. Mặc dù Yaml được sử dụng rộng rãi nhưng có những nhược điểm:
...
- Các cặp khoá-giá trị cần phải nằm ở các dòng khác nhau, từ đó làm file trở nên dài thêm<br><br>
  Neep sẽ phần nào khắc phục những điều đó bởi các yếu tố như:<br>
...
```
story "
        ngay xua ngay xua..        \" aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa \"
...
```
thoi_gian `60 * 60 * 24 * 3` # don vi: giay
```
...
thanh_tuu [
    {
        thoi_gian "27/10/1999"
        noi_dung "Ra doi!"
    }
    {
        thoi_gian "?/?/2005"
        noi_dung "Bat dau di hoc"
    }
]
